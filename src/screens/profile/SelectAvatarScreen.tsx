...
type SelectAvatarRouteProp = RouteProp<AuthStackParamList, "SelectAvatar">;
type Nav = NativeStackNavigationProp<AuthStackParamList, "SelectAvatar">;

export default function SelectAvatarScreen() {
  const route = useRoute<SelectAvatarRouteProp>();
  ...
  const handleProceed = async () => {
    ...
    if (from === "createProfile" || from === "femaleCreateProfile") {
      navigation.goBack();
    } else {
...
// Reusable Avatar Grid Item Component
...
function AvatarGridItem({ avatar, selected, onSelect }: AvatarGridItemProps) {
  return (
    <Pressable
      onPress={onSelect}
      style={({ pressed }) => [
